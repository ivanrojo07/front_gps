            ...
            interacciones.forEach(element => {
                ...
                <div class="card" onclick='drawRoute(${JSON.stringify(element)})'>
                    <div class="row m-2">
                        ...
                        <div class="col-2">
                            <button class="btn btn-success" data-toggle="modal" data-target="#notificarModal" data-name="${ element.info_interaccion360 ? element.info_interaccion360.nombre+" "+element.info_interaccion360.apellido_paterno+" "+element.info_interaccion360.apellido_materno : element.interaccion_id }" data-image="${ element.info_interaccion360 ? element.info_interaccion360.image : "images/user.png"}">Notificar</button>
                        </div>
                    </div>
                </div>
                `;
...
// evento para obtener informacion de usuario a notificar y
// enviarlo al modal
$("#notificarModal").on("show.bs.modal",function(event){
	// Button that triggered the modal
		...
		// variable del titulo de usuario
		var title = document.getElementById("notificarModalLabel")
		// actualizar el title
		title.innerHTML="Notificar a "+name
		// div modal body
		var body_modal = document.getElementById("user_modal")
		// Insertar el html con la inffo del usuario
		body_modal.innerHTML=`
		<div class="row">
			<div class="col-4 m-auto">
    			<img src="${ image }" class="img-thumbnail rounded-circle" height="25" alt="avatar">
    		</div>
